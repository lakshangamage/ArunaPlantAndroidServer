...
Database settings
 ****************************************************/
$db_server			= 'fhjffh';				// Database server, usually "localhost",
// on (mt) servers something like internal-db.s12345.gridserver.com
$db_name 			= 'gsgsgshg';				// Database name, leave empty for 'all databases'
$db_user 		    = 'fghfhfh';				// Database username
$db_pass 		    = 'gfhfhfh';				// Database password
...
E-mail settings
 ****************************************************/
$website            = 'arunaplant.com';		    // Your site's domain (without www. part)
$send_to 		    = 'lakshangamage.13@cse.mrt.ac.lk';		        // backup file will be sent to?
$from 		        = 'webapp@' . $website;	// some hosting providers won’t let you send backups from invalid e-mail address
...
$full_path      = '/home/arunapl1/public_html/webapp/mailbackup';
...
function send_attachment($file, $file_is_db = true) {
    ...
    $sent       = 'No';
    $subject    = 'Database backup - ' . ($file_is_db ? 'db dump' : 'report'). ' [' . $website . ']';
    $body = 'Database backup file:' . "\n" . ' - ' . $file . "\n\n";


    $email = new PHPMailer();
    $email->From      = $from;
    $email->FromName  = 'webapp';
